...
const translations = {
    sv: {
        ...
        'hero.lead': 'En steg-för-steg guide för att radera din information från Ratsit, Hitta, Eniro och andra öppna register.',

        // Intro
        'intro.text': 'Denna guide innehåller direktlänkar till borttagningssidor samt juridiska mallar med hänvisning till aktuella rättsfall. De flesta guider online är ofullständiga eller föråldrade.',

        // Step 1
        'step1.title': 'Grundförutsättningar',
        'step1.subtitle': 'Utan dessa steg återkommer din information inom 30 dagar',
        'step1.phone.title': 'Hemligt telefonnummer',
        'step1.phone.desc': 'Söktjänster köper data från telekomoperatörer. Stäng av denna källa först.',
        'step1.phone.step1': 'Kontakta din operatör',
        'step1.phone.step2': 'Begär hemligt nummer och återkalla samtycke till nummerupplysning',
        'step1.phone.step3': 'Vänta 1–2 veckor för uppdatering',
        'step1.phone.quote': '"Jag vill ha hemligt telefonnummer och drar tillbaka mitt samtycke till nummerupplysning och marknadsföring."',
        'step1.phone.operators': 'Kontakta din operatör',
        'step1.spar.title': 'SPAR-registret',
        'step1.spar.desc': 'Stoppa staten från att sälja din adress till marknadsförare.',
        ...
        'service.ratsit.desc': 'Den vanliga "Dölj"-funktionen varar endast 12 månader. Denna länk ger fullständig borttagning.',
        'service.ratsit.action': 'Logga in med BankID → Bekräfta',
        'service.hitta.desc': 'Sök ditt nummer eller namn, klicka "Ta bort" och signera.',
        'service.hitta.action': 'Signera med BankID',
        'service.eniro.desc': 'Sök din profil, välj "Uppdatera" och sedan "Ta bort profil helt".',
        ...
        'service.mrkoll.desc': 'Återpublicerar ofta efter 30 dagar. Kontrollera regelbundet eller maila',
        'service.mrkoll.action': 'Välj "Dölj" för adress och telefon',
        'service.birthday.desc': 'Begär länk till hanteringsportalen via e-post, logga sedan in med BankID och välj "Helt dold".',
        ...
        'template2.note': 'För tjänster som hävdar utgivningsbevis eller inte svarar. Hänvisar till Kammarrättens mål 6027-23.',
        'copy': 'Kopiera',

        // Step 4
        'step4.title': 'Ta bort från sökresultat',
        'step4.subtitle': 'Google kan visa cachade resultat i flera veckor efter borttagning',
        ...
        'maintenance.30days.text': 'Kontrollera MrKoll – de återpublicerar frekvent',
        'maintenance.12months': '12 månader',
        'maintenance.12months.text': 'Förnya Ratsit-spärren om du använde "Dölj" istället för "Ta bort"',
        'maintenance.change': 'Vid byte',
        'maintenance.change.text': 'Verifiera hemligt nummer efter operatörs- eller abonnemangsbyte',

        // FAQ
        'faq.title': 'Vanliga frågor',
        'faq.lexbase.q': 'Fungerar detta för Lexbase och Krimfup?',
        'faq.lexbase.a': 'Det är svårt. Använd mall 2 och hänvisa till Kammarrättens dom. Som alternativ, fokusera på att ta bort Google-sökresultaten så informationen blir svårare att hitta.',
        'faq.birthday.q': 'Hur fungerar Birthday.se:s nya självbetjäning?',
        'faq.birthday.a': 'Birthday.se har infört en BankID-portal för synlighetshantering. Maila info@birthday.se för att få en personlig länk till appen.minauppgifter.se. Där kan du välja mellan "Helt synlig", "Delvis synlig" (endast namn) eller "Helt dold" (rekommenderas). Ändringen träder i kraft inom 60 minuter.',
        'faq.service.q': 'Kan jag anlita en betaltjänst?',
        'faq.service.a': 'Tjänster som DoldAdress finns, men de utför samma steg som beskrivs här. Processen tar cirka 20 minuter.',

        // Tracker
        'tracker.title': 'Spåra din status',
        'tracker.intro': 'Håll koll på vilka tjänster som fortfarande visar dina uppgifter. All data sparas endast lokalt i din webbläsare.',
        ...
        'tracker.privacy.text': 'Ingen data skickas till någon server. Allt sparas endast i din webbläsare (localStorage). Om du byter webbläsare eller rensar webbläsardata försvinner informationen — använd "Exportera" för säkerhetskopiering.',
        ...
        'confirm.text': 'All spårningsdata kommer att raderas. Detta kan inte ångras.',
        ...
        'alert.import': 'Kunde inte läsa filen. Kontrollera att det är en giltig JSON-fil.',
        'alert.copy': 'Kunde inte kopiera. Markera texten manuellt.',

        // Footer
        'footer.updated': 'Senast uppdaterad: December 2025',
        'footer.disclaimer': 'Denna guide är framtagen i informationssyfte. För juridisk rådgivning, kontakta en kvalificerad jurist.',
        ...
        'stale.alert.plural': '⚠️ {count} tjänster har inte kontrollerats på över 30 dagar.',

        // Rattigheter page
        'rights.hero.meta': 'Juridisk bakgrund',
        'rights.hero.title': 'Dina rättigheter',
        'rights.hero.lead': 'Förstå varför svenska söktjänster kan publicera dina uppgifter — och varför du har rätt att få dem borttagna.',
        'rights.intro': 'Denna sida ger en översikt över relevant lagstiftning. Den utgör inte juridisk rådgivning. För specifika frågor, kontakta en kvalificerad jurist eller Integritetsskyddsmyndigheten (IMY).',
        'rights.s1.title': 'Offentlighetsprincipen',
        'rights.s1.subtitle': 'Varför uppgifter är offentliga från början',
        'rights.s1.p1': 'Sverige har en grundlagsskyddad princip om offentlighet för officiella handlingar, känd som offentlighetsprincipen. Den finns i Tryckfrihetsförordningen och ger allmänheten rätt att ta del av handlingar hos myndigheter.',
        'rights.s1.p2': 'Detta innebär att uppgifter från exempelvis Skatteverket, folkbokföringen och bolagsregistret är tillgängliga för allmänheten. Söktjänster som Ratsit och Hitta hämtar data från dessa offentliga källor.',
        ...
        'rights.s2.p1': 'Många söktjänster har registrerat sig som nyhetsmedier genom att ansöka om ett frivilligt utgivningsbevis. Detta ger dem skydd under Yttrandefrihetsgrundlagen (YGL), som historiskt har ansetts ha företräde framför GDPR.',
        'rights.s2.p2': 'Genom att hävda att de bedriver "journalistisk verksamhet" har dessa företag kunnat undvika GDPR:s krav på samtycke och rätt till radering.',
        'rights.s2.box.title': 'Problemet',
        'rights.s2.box.text': 'De flesta söktjänster har ett kommersiellt syfte — de säljer bakgrundskontroller och tjänar pengar på reklam. Deras verksamhet har lite med traditionell journalistik att göra.',
        'rights.s3.title': 'Kammarrättens dom 6027-23',
        'rights.s3.subtitle': 'Det banbrytande avgörandet från mars 2024',
        'rights.s3.p1': 'I mars 2024 avkunnade Kammarrätten en dom som förändrar rättsläget. Domstolen slog fast att utgivningsbevis inte automatiskt ger undantag från GDPR.',
        'rights.s3.p2': 'Domstolen betonade att EU-rätten kräver en proportionalitetsavvägning mellan yttrandefrihet och integritetsskydd. När en tjänsts primära syfte inte är journalistiskt, kan GDPR gälla fullt ut.',
        'rights.s3.box.title': 'Vad detta betyder för dig',
        'rights.s3.box.li1': 'Söktjänster med kommersiellt syfte måste respektera din rätt till radering',
        ...
        'rights.s4.erasure.text': 'Du har rätt att begära att personuppgifter raderas när det inte längre finns rättslig grund för behandlingen.',
        'rights.s4.object.title': 'Rätt att invända',
        'rights.s4.object.text': 'Du kan invända mot behandling som grundar sig på "berättigat intresse", till exempel direktmarknadsföring.',
        'rights.s4.deadline.title': 'Svarsfrist',
        'rights.s4.deadline.text': 'Företag måste svara på din begäran inom 30 dagar. Vid komplicerade ärenden kan fristen förlängas med ytterligare 60 dagar.',
        'rights.s4.complain.title': 'Rätt att klaga',
        'rights.s4.complain.text': 'Om ett företag inte efterlever kan du lämna klagomål till IMY.',
        ...
        'rights.s5.obj1.a': 'Kammarrättens dom 6027-23 slår fast att utgivningsbevis inte automatiskt undantar från GDPR. En proportionalitetsavvägning måste göras.',
        'rights.s5.obj2.q': '"Uppgifterna är offentliga"',
        'rights.s5.obj2.a': 'Att data är offentligt tillgänglig betyder inte att den får sammanställas och publiceras kommersiellt utan möjlighet till radering.',
        'rights.s5.obj3.q': '"Vi bedriver journalistik"',
        'rights.s5.obj3.a': 'Bakgrundskontroller och personsök är inte journalistisk verksamhet i traditionell mening. Verksamhetens faktiska syfte är avgörande.',
        'rights.s5.obj4.q': '"Vi kan bara dölja, inte radera"',
        'rights.s5.obj4.a': 'Fråga specifikt efter radering enligt artikel 17. "Döljning" kan vara temporär och uppgifterna kan dyka upp igen.',
        ...
        'rights.cta.text': 'Guiden innehåller färdiga mallar och direktlänkar till alla tjänster.',
    ...
    en: {
        ...
        'hero.lead': 'A step-by-step guide to delete your information from Ratsit, Hitta, Eniro and other public registers.',

        // Intro
        'intro.text': 'This guide contains direct links to removal pages and legal templates referencing current case law. Most online guides are incomplete or outdated.',

        // Step 1
        'step1.title': 'Prerequisites',
        'step1.subtitle': 'Without these steps, your information will return within 30 days',
        'step1.phone.title': 'Unlisted Phone Number',
        'step1.phone.desc': 'Search services buy data from telecom operators. Turn off this source first.',
        'step1.phone.step1': 'Contact your operator',
        'step1.phone.step2': 'Request an unlisted number and revoke consent for directory services',
        'step1.phone.step3': 'Wait 1–2 weeks for update',
        'step1.phone.quote': '"I want an unlisted phone number and withdraw my consent for directory services and marketing."',
        ...
        'service.ratsit.desc': 'The standard "Hide" function lasts only 12 months. This link provides complete removal.',
        'service.ratsit.action': 'Log in with BankID → Confirm',
        'service.hitta.desc': 'Search for your number or name, click "Remove" and sign.',
        'service.hitta.action': 'Sign with BankID',
        'service.eniro.desc': 'Search for your profile, select "Update" then "Remove profile completely".',
        ...
        'service.mrkoll.desc': 'Often republishes after 30 days. Check regularly or email',
        'service.mrkoll.action': 'Select "Hide" for address and phone',
        'service.birthday.desc': 'Request link to management portal via email, then log in with BankID and select "Completely hidden".',
        ...
        'email.krimfup.note': 'Difficult to get removal from. Start with template 2.',
        'email.lexbase.note': 'Claims publication certificate. Start with template 2.',
        'template1.title': 'Template 1: Standard Request',
        'template2.title': 'Template 2: Request with Legal Reference',
        'template2.note': 'For services claiming publication certificates or not responding. References Court of Appeal case 6027-23.',
        'copy': 'Copy',
        ...
        'maintenance.12months.text': 'Renew Ratsit block if you used "Hide" instead of "Remove"',
        'maintenance.change': 'On change',
        'maintenance.change.text': 'Verify unlisted number after operator or subscription change',

        // FAQ
        'faq.title': 'Frequently Asked Questions',
        'faq.lexbase.q': 'Does this work for Lexbase and Krimfup?',
        'faq.lexbase.a': 'It\'s difficult. Use template 2 and reference the Court of Appeal ruling. Alternatively, focus on removing Google search results to make the information harder to find.',
        'faq.birthday.q': 'How does Birthday.se\'s new self-service work?',
        'faq.birthday.a': 'Birthday.se has introduced a BankID portal for visibility management. Email info@birthday.se for a personal link to appen.minauppgifter.se. There you can choose between "Fully visible", "Partially visible" (name only) or "Completely hidden" (recommended). Changes take effect within 60 minutes.',
        'faq.service.q': 'Can I hire a paid service?',
        'faq.service.a': 'Services like DoldAdress exist, but they perform the same steps described here. The process takes about 20 minutes.',

        // Tracker
        'tracker.title': 'Track Your Status',
        'tracker.intro': 'Keep track of which services still show your information. All data is stored only locally in your browser.',
        ...
        'tracker.privacy.text': 'No data is sent to any server. Everything is stored only in your browser (localStorage). If you switch browsers or clear browser data, the information is lost — use "Export" for backup.',
        ...
        'footer.disclaimer': 'This guide is for informational purposes. For legal advice, consult a qualified lawyer.',
        ...
        'stale.alert.plural': '⚠️ {count} services have not been checked for over 30 days.',

        // Rattigheter page
        'rights.hero.meta': 'Legal Background',
        'rights.hero.title': 'Your Rights',
        'rights.hero.lead': 'Understand why Swedish search services can publish your information — and why you have the right to have it removed.',
        'rights.intro': 'This page provides an overview of relevant legislation. It does not constitute legal advice. For specific questions, contact a qualified lawyer or the Swedish Authority for Privacy Protection (IMY).',
        'rights.s1.title': 'Freedom of Information',
        'rights.s1.subtitle': 'Why information is public to begin with',
        'rights.s1.p1': 'Sweden has a constitutionally protected principle of public access to official documents, known as the principle of public access. It is found in the Freedom of the Press Act and gives the public the right to access documents held by authorities.',
        'rights.s1.p2': 'This means that information from, for example, the Tax Agency, the population register and the company register is available to the public. Search services like Ratsit and Hitta retrieve data from these public sources.',
        ...
        'rights.s2.p1': 'Many search services have registered as news media by applying for a voluntary publication certificate. This gives them protection under the Freedom of Expression Act (YGL), which has historically been considered to take precedence over GDPR.',
        'rights.s2.p2': 'By claiming to conduct "journalistic activities", these companies have been able to avoid GDPR requirements for consent and the right to erasure.',
        'rights.s2.box.title': 'The Problem',
        'rights.s2.box.text': 'Most search services have a commercial purpose — they sell background checks and make money from advertising. Their activities have little to do with traditional journalism.',
        'rights.s3.title': 'Court of Appeal Case 6027-23',
        'rights.s3.subtitle': 'The landmark ruling from March 2024',
        'rights.s3.p1': 'In March 2024, the Court of Appeal issued a ruling that changes the legal landscape. The court established that publication certificates do not automatically exempt from GDPR.',
        'rights.s3.p2': 'The court emphasized that EU law requires a proportionality assessment between freedom of expression and privacy protection. When a service\'s primary purpose is not journalistic, GDPR may apply fully.',
        'rights.s3.box.title': 'What this means for you',
        'rights.s3.box.li1': 'Search services with commercial purposes must respect your right to erasure',
        'rights.s3.box.li2': 'They can no longer hide behind publication certificates',
        'rights.s3.box.li3': 'IMY has announced stricter supervision of these services',
        ...
        'rights.s4.erasure.text': 'You have the right to request that personal data be deleted when there is no longer a legal basis for processing.',
        'rights.s4.object.title': 'Right to Object',
        'rights.s4.object.text': 'You can object to processing based on "legitimate interest", for example direct marketing.',
        'rights.s4.deadline.title': 'Response Deadline',
        'rights.s4.deadline.text': 'Companies must respond to your request within 30 days. In complex cases, the deadline may be extended by an additional 60 days.',
        'rights.s4.complain.title': 'Right to Complain',
        'rights.s4.complain.text': 'If a company does not comply, you can file a complaint with IMY.',
        ...
        'rights.s5.obj1.a': 'Court of Appeal case 6027-23 establishes that publication certificates do not automatically exempt from GDPR. A proportionality assessment must be made.',
        'rights.s5.obj2.q': '"The data is public"',
        'rights.s5.obj2.a': 'That data is publicly available does not mean it can be compiled and published commercially without the possibility of deletion.',
        'rights.s5.obj3.q': '"We conduct journalism"',
        'rights.s5.obj3.a': 'Background checks and person searches are not journalistic activities in the traditional sense. The actual purpose of the business is decisive.',
        'rights.s5.obj4.q': '"We can only hide, not delete"',
        'rights.s5.obj4.a': 'Specifically request deletion under Article 17. "Hiding" may be temporary and the data may reappear.',
        ...
        'rights.cta.text': 'The guide contains ready-made templates and direct links to all services.',
